...
* */
@Component
public class AccountEventListenerB {
    private final AccountEventRepository accountEventRepository;

    public AccountEventListenerB(AccountEventRepository accountEventRepository) {
    ...
    public void listenAccountCreation(String message) {
        System.out.println("[Consumer B] Received Kafka Message: " + message);
